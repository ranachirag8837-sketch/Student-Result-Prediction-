...
if predict:
    ...
    # =============================
    # Prediction Result Display (Image 3 Style)
    # =============================
    with col2:
        st.write("") 
        components.html(f"""
        <div style="
            ...
            <h2 style="margin:0; font-size: 28px;">Prediction Result</h2>
            ...
            <h1 style="color:{color}; font-size:70px; margin:15px 0; font-weight:900; letter-spacing: 2px;">
    ...
    # =============================
    # Topic-wise Performance (Image 2 Style)
    # =============================
    components.html(f"""
    <div style="
        margin-top:20px;
    ...
    ">
        ...
        <div style="margin-bottom:25px;">
            <div style="display:flex; justify-content:space-between; align-items: center; font-weight:bold;">
                <span style="font-size: 16px;">📘 <b>Mathematics:</b> <span style="font-weight:normal; opacity:0.9;">Concept clear, improve speed.</span></span>
                <span style="font-size: 18px;">75%</span>
            </div>
            <div style="background:rgba(255,255,255,0.15); border-radius:10px; height:10px; margin-top:12px;">
                <div style="width:75%; background:#60a5fa; height:100%; border-radius:10px; box-shadow: 0 0 10px #60a5fa;"></div>
            </div>
        </div>

        <div style="margin-bottom:25px;">
            <div style="display:flex; justify-content:space-between; align-items: center; font-weight:bold;">
                <span style="font-size: 16px;">💻 <b>Programming:</b> <span style="font-weight:normal; opacity:0.9;">Good logic, practice projects.</span></span>
                <span style="font-size: 18px;">88%</span>
            </div>
            <div style="background:rgba(255,255,255,0.15); border-radius:10px; height:10px; margin-top:12px;">
                <div style="width:88%; background:#22c55e; height:100%; border-radius:10px; box-shadow: 0 0 10px #22c55e;"></div>
            </div>
        </div>
        ...
        <div style="
            ...
            <span style="font-size:18px; line-height: 1.5;">{advice}</span>
        </div>
    </div>
    """, height=500)
    ...
    fig.patch.set_facecolor('#000000') # Background black as per your code
    ax.set_facecolor('#4B0082') # Plot area purple
